...
CREATE TABLE users (
  ...
  role ENUM('super_admin', 'restaurant_owner', 'restaurant_staff', 'manager') NOT NULL DEFAULT 'restaurant_owner',
...
CREATE TABLE restaurant_users (
  ...
  role ENUM('restaurant_owner', 'restaurant_staff', 'manager') NOT NULL DEFAULT 'restaurant_staff',
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
